...
keywords: IBM, activity tracker, LogDNA, event, security, audit, audit Cloud Shell commands, Cloud Shell logs
...
# Activity Tracker events for {{site.data.keyword.cloud-shell_notm}}
{: #at_events}
...
Events are available in the **Dallas** region. To view events, create an instance of the {{site.data.keyword.at_short}} service. For more information, see [Getting started with {{site.data.keyword.at_short}}](/docs/services/Activity-Tracker-with-LogDNA?topic=logdnaat-getting-started).

{{site.data.keyword.at_full_notm}} can have only one instance per region. To view events, you must access the web UI of the {{site.data.keyword.at_short}} service in the `us-south` region. For more information, see [Launching the web UI through the IBM Cloud UI](/docs/services/Activity-Tracker-with-LogDNA?topic=logdnaat-launch#launch_step2).


<!-- Update later when multi regions are supported -->
<!-- 
...
{{site.data.keyword.at_short}} events contain fields that describe the action that occurred. Values in the `requestData` and `responseData` fields are specific to {{site.data.keyword.cloud-shell_notm}}, and the other fields are common to all {{site.data.keyword.at_short}} events. For a more information about common fields, see [Event fields](/docs/services/Activity-Tracker-with-LogDNA?topic=logdnaat-event).
